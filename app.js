...
const BANK_CATEGORY_MAP = {
    ...
    // Еда
    'рестораны': '🍔 Еда', 'кафе': '🍔 Еда', 'фастфуд': '🍔 Еда', 'яндекс еда': '🍔 Еда',
    'mcdonalds': '🍔 Еда', 'kfc': '🍔 Еда', 'burger king': '🍔 Еда',
    // Транспорт
    ...
    // Здоровье
    'аптека': '💊 Здоровье', 'медицина': '💊 Здоровье', 'pharmacy': '💊 Здоровье',
    // Одежда
    'одежда': '👕 Одежда', 'обувь': '👕 Одежда',
    // Развлечения
    'развлечения': '🎮 Развлечения', 'кино': '🎮 Развлечения',
    // Дом
    'хозтовары': '🏠 Дом', 'мебель': '🏠 Дом',
    // Кофе
    'кофейня': '☕ Кофе', 'кофе': '☕ Кофе'
};

// Словарь для парсинга "место совершения операции" из банковской выписки
