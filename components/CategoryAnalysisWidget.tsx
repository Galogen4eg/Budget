...
const CategoryAnalysisWidget: React.FC<CategoryAnalysisWidgetProps> = ({ transactions, categories, settings, onClick }) => {
  ...
  return (
    <motion.div 
        ...
        whileTap={{ scale: 0.98 }}
        onClick={onClick}
        className="bg-white dark:bg-[#1C1C1E] p-4 rounded-[2.2rem] border border-gray-100 dark:border-white/5 shadow-sm dark:shadow-none h-full flex flex-col cursor-pointer group relative overflow-hidden transition-all"
    >
