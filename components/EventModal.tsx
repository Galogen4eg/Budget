  ...
  return (
    <div className="fixed inset-0 z-[600] flex items-end md:items-center justify-center">
      ...
      <motion.div 
        ...
        animate={{ y: 0 }} 
        exit={{ y: '100%' }} 
        className="relative bg-[#F2F2F7] dark:bg-black w-full max-w-lg md:max-w-4xl md:rounded-[3rem] rounded-t-[3rem] shadow-2xl overflow-hidden flex flex-col max-h-[95vh]" 
