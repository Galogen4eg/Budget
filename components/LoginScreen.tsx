...
export const LoginScreen: React.FC = () => {
  ...
  const handleGoogleClick = async () => {
    try {
      ...
      const targetFid = activeTab === 'register' && registerType === 'join' ? inviteCode.trim() : undefined;
      await loginWithGoogle(targetFid);
    } catch (e: any) {
      toast.error(e?.message || 'Ошибка входа Google');
    } finally {
