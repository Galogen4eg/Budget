...
import { Check, AlertCircle, DollarSign, Calendar, Edit2, Plus } from 'lucide-react';
...
const MandatoryExpensesList: React.FC<MandatoryExpensesListProps> = ({ expenses, transactions, settings, currentMonth, onEdit, onAdd }) => {
                ...
                <div className="text-right flex items-center gap-2">
                    {expense.isPaid ? (
                        ...
                        <div className="flex flex-col items-end">
                            <span className="text-xs md:text-sm font-black text-[#1C1C1E] dark:text-white">{expense.amount.toLocaleString()}</span>
                            {expense.progress > 0 && (
