...
const MonthlyAnalyticsWidget: React.FC<MonthlyAnalyticsWidgetProps> = ({ transactions, currentMonth, settings }) => {
  ...
  return (
    <div className="bg-white dark:bg-[#1C1C1E] p-4 md:p-5 rounded-[2.2rem] border border-gray-100 dark:border-white/5 shadow-sm dark:shadow-none flex flex-col h-full relative overflow-hidden group">
