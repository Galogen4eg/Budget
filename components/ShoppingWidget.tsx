...
const ShoppingWidget: React.FC<ShoppingWidgetProps> = ({ items, onClick }) => {
  ...
  return (
    <div 
        onClick={onClick}
        className="bg-white dark:bg-[#1C1C1E] p-5 rounded-[2.2rem] border border-gray-100 dark:border-white/5 shadow-sm dark:shadow-none w-full h-full flex flex-col cursor-pointer group relative overflow-hidden transition-all hover:scale-[1.01] active:scale-[0.99]"
    >
        {/* Header */}
