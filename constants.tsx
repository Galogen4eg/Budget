...
export const INITIAL_CATEGORIES: Category[] = [
  ...
  { id: 'grocery_pyaterochka', label: 'Пятерочка', icon: 'ShoppingBasket', color: '#34C759', parentId: 'food' },
  { id: 'grocery_magnit', label: 'Магнит', icon: 'ShoppingBasket', color: '#34C759', parentId: 'food' },
  { id: 'grocery_perekrestok', label: 'Перекресток', icon: 'ShoppingBasket', color: '#34C759', parentId: 'food' },
  { id: 'grocery_vkusvill', label: 'ВкусВилл', icon: 'ShoppingBasket', color: '#34C759', parentId: 'food' },
  { id: 'grocery_lenta', label: 'Лента', icon: 'ShoppingBasket', color: '#34C759', parentId: 'food' },
  { id: 'grocery_ashan', label: 'Ашан', icon: 'ShoppingBasket', color: '#34C759', parentId: 'food' },
  { id: 'grocery_samokat', label: 'Самокат', icon: 'ShoppingBasket', color: '#34C759', parentId: 'food' },
  { id: 'grocery_globus', label: 'Глобус', icon: 'ShoppingBasket', color: '#34C759', parentId: 'food' },
  { id: 'grocery_chizhik', label: 'Чижик', icon: 'ShoppingBasket', color: '#34C759', parentId: 'food' },
  { id: 'grocery_dixy', label: 'Дикси', icon: 'ShoppingBasket', color: '#34C759', parentId: 'food' },
  { id: 'grocery_spar', label: 'Спар', icon: 'ShoppingBasket', color: '#34C759', parentId: 'food' },
  { id: 'grocery_svetoform', label: 'Светофор', icon: 'ShoppingBasket', color: '#34C759', parentId: 'food' },
  { id: 'grocery_vysshaya_liga', label: 'Высшая Лига', icon: 'ShoppingBasket', color: '#34C759', parentId: 'food' },

  // Сети фастфуда и общепита (Подкатегории "Кафе и Рестораны")
  { id: 'fastfood_vnoit', label: 'Вкусно и точка', icon: 'Utensils', color: '#FF9500', parentId: 'restaurants' },
  { id: 'fastfood_bk', label: 'Бургер Кинг', icon: 'Utensils', color: '#FF9500', parentId: 'restaurants' },
  { id: 'fastfood_rostics', label: 'Ростикс / KFC', icon: 'Utensils', color: '#FF9500', parentId: 'restaurants' },
  { id: 'fastfood_dodo', label: 'Додо Пицца', icon: 'Utensils', color: '#FF9500', parentId: 'restaurants' },
  { id: 'fastfood_pizzafabrika', label: 'ПиццаФабрика', icon: 'Utensils', color: '#FF9500', parentId: 'restaurants' },
  { id: 'fastfood_teremok', label: 'Теремок', icon: 'Utensils', color: '#FF9500', parentId: 'restaurants' },
  { id: 'fastfood_kroshka', label: 'Крошка Картошка', icon: 'Utensils', color: '#FF9500', parentId: 'restaurants' },
  { id: 'fastfood_shokoladnitsa', label: 'Шоколадница', icon: 'Utensils', color: '#FF9500', parentId: 'restaurants' },
