...
// Standard online-only Firestore initialization.
// Removed persistentLocalCache and ignoreUndefinedProperties (unless needed for logic, but cleaner without if strict)
