...
const PRODUCT_KEYWORDS: Record<string, string[]> = {
  'produce': [
      ...
      'салат', 'укроп', 'петрушк', 'кинз', 'редис', 'авокадо', 'киви', 'манго', 'гриб', 'шампиньон'
  ],
  'dairy': [
      'молок', 'кефир', 'творог', 'сыр', 'сметан', 'йогурт', 'масло сливоч', 'сливки', 'яйц', 'яйцо', 'ряженк', 'снежок',
      'масса творож', 'сырок', 'маргарин', 'сгущен', 'простокваш', 'айран', 'тан'
  ],
  'meat': [
      ...
      'сельдь', 'скумбри', 'креветк', 'краб', 'икра', 'тушенк'
  ],
  'bakery': [
      'хлеб', 'батон', 'булк', 'выпечк', 'пирог', 'лаваш', 'печень', 'сушки', 'пряник', 'торт', 'пирож', 'круассан',
      'вафл', 'сухар', 'лепешк', 'бублик', 'кекс', 'пончик', 'пирожен', 'чиабатта'
  ],
  'grocery': [
  ...
  'drinks': [
      ...
      'кисель', 'фанта', 'спрайт', 'пепси', 'тархун', 'боржоми'
  ],
  'household': [
      'мыло', 'порошок', 'гель', 'шампунь', 'паста', 'бумага', 'салфет', 'губк', 'пакет', 'средство', 'domestos', 
      'fairy', 'фольга', 'перчатк', 'бритв', 'деодорант', 'крем', 'щетк', 'ватн', 'диски', 'прокладк', 'тампон', 
      'памперс', 'подгузник', 'батарейк', 'лампочк', 'освежитель', 'тряпк', 'фольга', 'пленка'
  ],
};
