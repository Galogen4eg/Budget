...
import { Transaction, AppSettings, FamilyMember, SavingsGoal, ShoppingItem, FamilyEvent, Subscription, MeterReading, LoyaltyCard, LearnedRule, Category } from '../types';
...
export const migrateFamilyData = async (sourceId: string, targetId: string) => {
    ...
    const collectionsToMigrate = [
        'transactions', 'shopping', 'events', 
        'goals', 'members', 'categories', 'rules', 
        'knowledge', 'projects', 'loyalty'
    ];
